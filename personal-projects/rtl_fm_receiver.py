...
class rtl_fm_receiver(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        _use_envelope_check_box = Qt.QCheckBox('Non Coherent Demodulation')
        ...
        self.analog_fm_deemph_0 = analog.fm_deemph(fs=samp_rate / 5, tau=75e-6)
        self._Channel_range = Range(88.3, 106.9, 0.2, 98.3, 200)
