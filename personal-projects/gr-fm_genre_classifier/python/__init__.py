...
'''
This is the GNU Radio FM_GENRE_CLASSIFIER module. Place your Python package
...
# import swig generated symbols into the fm_genre_classifier namespace
try:
    # this might fail if the module is python-only
    from .fm_genre_classifier_swig import *
